...
fn normalize_price(
	...
	let adjusted_exponent = expected_exponent - q;
	let normalized_price = match adjusted_exponent.signum() {
		0 => p,
		1 => p * u64::pow(10u64, adjusted_exponent as u32),
		-1 => p / u64::pow(10u64, adjusted_exponent.abs() as u32),
		_ => unreachable!(),
	};
